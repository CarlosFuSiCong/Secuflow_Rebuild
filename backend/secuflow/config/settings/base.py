...
MIDDLEWARE = [
    ...
    # Place API logging and envelope early so responses are rendered before CommonMiddleware touches content
    ...
    # Render DRF responses IMMEDIATELY after envelope processing, before CommonMiddleware
